...
import com.mc.lld.order.payment.CreditCardPayment;
...
public class OnlineShoppingServiceDemo {
    public static void run() {
        ...
        // Add products
        Product product1 = new Product("Smartphone", "High-end smartphone", 999.99, 10);
        Product product2 = new Product("Laptop", "Powerful gaming laptop", 1999.99, 5);
