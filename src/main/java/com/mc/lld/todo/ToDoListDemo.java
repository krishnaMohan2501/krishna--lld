...
import com.mc.lld.todo.service.PhonePeCoding;
...
//        todoList.removeTask(task3.getId());
        ...
        list.add(7);
        list.add(21);
        int theLatestUniqueElement = PhonePeCoding.getTheFirstUniqueElement1(list);
        System.out.println("theLatestUniqueElement: " + theLatestUniqueElement);
